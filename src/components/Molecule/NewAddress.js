        ...
        <View style={styles.container}>
          ...
          >
            <View style={{ flex: 1, backgroundColor: 'white', borderRadius: 10, width: 800, height: 300, padding: 20, paddingTop: 10, paddingBottom: 10, position: 'absolute', left: 0, top: 0}}>
              <View>
                <Text style={{paddingLeft: 30, fontSize: 20, color: 'black', fontWeight: 'bold', marginBottom: 10}}>Create New Report</Text>
              </View>
              <View style={{flexDirection: 'row', marginTop: 30}}>
                <Text style={{fontSize: 20, lineHeight: 30}}>Address: </Text>
                <TextInput
