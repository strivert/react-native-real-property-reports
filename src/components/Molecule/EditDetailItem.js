 ...
 */
class EditDetailItem extends Component {
  /**
  ...
  render() {
    ...
    return (
        <View style={styles.container}>
          ...
          isVisible={true}
          onBackdropPress = {()=>{
            this.props.onDisableEditDetailItemVisible();
          }}
          >
            <View style={{ flex: 1, backgroundColor: 'white', borderRadius: 10, width: 800, height: 300, padding: 20, paddingTop: 10, paddingBottom: 10, position: 'absolute', left: 0, top: 0}}>
              <View>
                <Text style={{paddingLeft: 10, fontSize: 20, color: 'black', fontWeight: 'bold', marginBottom: 10}}>Edit Selection</Text>
              </View>
              ...
              <View style={{height: 80, marginTop: 100, flexDirection: 'row', paddingTop: 0, justifyContent: 'space-between'}}>
                <TextBtn
                  ...
                  onPress={()=>{
                    this.props.onDelEditDetailItem();
                  }}
                >
                  Delete
                </TextBtn>
                ...
                <TextBtn
                  ...
                  style={{height: 34, resizeMode: 'stretch', margin: 10, marginRight: 20}}
                  onPress={()=>{
                    this.props.onSaveEditDetailItem(text);
                  }}
                >
                  Save
                </TextBtn>
