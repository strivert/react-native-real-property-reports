  ...
  render() {
    ...
    return (
        <View style={styles.container}>
          ...
          >
            <View style={{ flex: 1, borderRadius: 10, width: 797, height: 550, position: 'absolute', right: 0, top: 20, padding: 40, paddingTop: 60, paddingBottom: 0, backgroundColor: 'black'}}>
              <View style={{flex: 1}}>
              {
                isAfterTake && 
